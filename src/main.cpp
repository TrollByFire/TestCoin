...
static const int64 nTargetTimespan = 1 * 1 *  15 * 60; // TestCoin: 15 minute retarget
static const int64 nTargetSpacing = 60; // TestCoin: 1 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca0dbcef40722d30e02ed56919197603c222072fc167ed781b3baa6e57f130ac");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "June 11, 2013: This coin is for testing purposes.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x77a2db761d302a8f0b3b62883a2f793efe635569505c27454950b447d989d58a"));
